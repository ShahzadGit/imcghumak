...
const FIRST_MERIT_LIST_GROUP: Group[] = [
  {
    name: "1st - Merit List - HSSC-1",
    href: "/shortlists/merit-list-hssc1.pdf",
    icon: Trophy,
  },
];

const SECOND_MERIT_LIST_GROUP: Group[] = [
  {
    name: "2nd - Merit List - Pre Medical",
    href: "/shortlists/2nd-MeritList-Pre-Medical.pdf",
    icon: HeartPulse,
  },
  {
    name: "2nd - Merit List - Pre Engineering",
    href: "/shortlists/2nd-MeritList-Pre-Engineering.pdf",
    icon: Cog,
  },
  {
    name: "2nd - Merit List - ICS",
    href: "/shortlists/2nd-MeritList-ICS.pdf",
    icon: Cpu,
  },
  {
...
// Shared card renderer for all sections — keeps styling in sync.
...
// Small section label used to separate 1st / 2nd merit list groups
const SubLabel: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="flex items-center gap-2 mb-2 sm:mb-2.5">
    <span className="h-px flex-1 bg-gray-200" />
    <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide text-gray-500 px-1">
      {children}
    </span>
    <span className="h-px flex-1 bg-gray-200" />
  </div>
        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="px-3 py-2 sm:px-6 sm:py-3">
                {/* 1st Merit List — centered single item */}
                <SubLabel>1st Merit List</SubLabel>
                <div className="flex justify-center">
                  {FIRST_MERIT_LIST_GROUP.map((group) => (
                    <div key={group.href} className="w-1/2 sm:w-2/5">
                      <GroupCard group={group} />
                    </div>
                  ))}
                ...
                {/* Divider between 1st and 2nd merit lists */}
                <div className="my-3 sm:my-4 border-t border-dashed border-gray-200" />

                {/* 2nd Merit List — responsive 2-column grid */}
                <SubLabel>2nd Merit List</SubLabel>
                <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                  {SECOND_MERIT_LIST_GROUP.map((group) => (
